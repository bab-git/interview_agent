...
def complete_interview(client: TestClient, skill: str, candidate_name: str) -> str:
    """Run one complete session and return its identifier."""
...
def main() -> None:
    ...
    with load_client() as client:
        created = client.post(
            ...
            json={
                "version": "v3",
                "description": "Comparison demo prompt with more explicit follow-up wording.",
                "base_version": "v2",
                "activate": True,
        ...
        interview_a = complete_interview(client, "Collaboration & Teamwork", "Prompt V1 Review Demo")

        client.post("/api/prompts/activate", json={"version": "v3"})
        interview_b = complete_interview(client, "Collaboration & Teamwork", "Prompt V3 Review Demo")
