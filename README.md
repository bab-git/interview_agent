...
1. Stateful interview flow
   Covered by [app/services/interview_engine.py](/Users/bhosseini/Documents/interview_agent/app/services/interview_engine.py).
   ...
   Verified by [tests/test_interview_engine.py](/Users/bhosseini/Documents/interview_agent/tests/test_interview_engine.py) and [tests/test_api_flow.py](/Users/bhosseini/Documents/interview_agent/tests/test_api_flow.py).

2. Deployable interface
   Covered by the FastAPI service in [app/main.py](/Users/bhosseini/Documents/interview_agent/app/main.py).
   The agent is callable over HTTP through `POST /api/interviews` and `POST /api/interviews/{interview_id}/reply`.
   Verified by [scripts/live_smoke_test.py](/Users/bhosseini/Documents/interview_agent/scripts/live_smoke_test.py).

3. Feedback submission with persistence
   Covered by `POST /api/feedback` and SQLite persistence in [app/db.py](/Users/bhosseini/Documents/interview_agent/app/db.py).
   Feedback is stored and can later be retrieved for a given conversation.
   Verified by [tests/test_feedback_api.py](/Users/bhosseini/Documents/interview_agent/tests/test_feedback_api.py).
...
4. Conversation retrieval
   ...
   Verified by [tests/test_api_flow.py](/Users/bhosseini/Documents/interview_agent/tests/test_api_flow.py).

5. Prompt loading from configuration
   Covered by [app/prompts.py](/Users/bhosseini/Documents/interview_agent/app/prompts.py) using versioned files under [prompts/versions](/Users/bhosseini/Documents/interview_agent/prompts/versions) and an active prompt selector in [prompts/active_prompt.json](/Users/bhosseini/Documents/interview_agent/prompts/active_prompt.json).
   New interviews use the active prompt version at the time they start.
   Verified by [tests/test_prompt_loading.py](/Users/bhosseini/Documents/interview_agent/tests/test_prompt_loading.py).

6. Tests
   Included:
   - [tests/test_interview_engine.py](/Users/bhosseini/Documents/interview_agent/tests/test_interview_engine.py)
   - [tests/test_feedback_api.py](/Users/bhosseini/Documents/interview_agent/tests/test_feedback_api.py)
   - [tests/test_prompt_loading.py](/Users/bhosseini/Documents/interview_agent/tests/test_prompt_loading.py)
   - [tests/test_api_flow.py](/Users/bhosseini/Documents/interview_agent/tests/test_api_flow.py)

7. README
   This file documents setup, running, assumptions, feedback submission, prompt updates, testing, and the reviewer walkthrough.

8. Demo walkthrough
   Covered by `make demo` and [scripts/demo_flow.py](/Users/bhosseini/Documents/interview_agent/scripts/demo_flow.py).
...
1. Containerized deployment
   Covered by [Dockerfile](/Users/bhosseini/Documents/interview_agent/Dockerfile) and [docker-compose.yml](/Users/bhosseini/Documents/interview_agent/docker-compose.yml).
...
2. Conversation discovery and filtering
   ...
   Implemented in [app/main.py](/Users/bhosseini/Documents/interview_agent/app/main.py) and [app/db.py](/Users/bhosseini/Documents/interview_agent/app/db.py).

3. Prompt versioning
   Covered by YAML prompt versions in [prompts/versions](/Users/bhosseini/Documents/interview_agent/prompts/versions), activation through `POST /api/prompts/activate`, and `prompt_version` persisted on every interview.
...
5. Basic observability
   ...
   - `GET /health`
   - `GET /api/metrics`
   - structured JSON event logs through [app/logging_utils.py](/Users/bhosseini/Documents/interview_agent/app/logging_utils.py)
...
1. A/B comparison
   ...
   Verified by [tests/test_bonus_features.py](/Users/bhosseini/Documents/interview_agent/tests/test_bonus_features.py).
...
3. CI/CD pipeline scaffold
   Covered by [ci.yml](/Users/bhosseini/Documents/interview_agent/.github/workflows/ci.yml).
...
4. Prompt update API
   ...
   A new prompt version can be created from an existing base version, optionally activated immediately, and stored in [prompts/versions](/Users/bhosseini/Documents/interview_agent/prompts/versions).
   Verified by [tests/test_bonus_features.py](/Users/bhosseini/Documents/interview_agent/tests/test_bonus_features.py).
...
- The interview flow is implemented as a state machine in [app/services/interview_engine.py](/Users/bhosseini/Documents/interview_agent/app/services/interview_engine.py), which keeps transitions explicit and testable.
...
- Local LLM support is implemented with Ollama in [app/services/llm.py](/Users/bhosseini/Documents/interview_agent/app/services/llm.py). The default model is `llama3.2:1b`, which is small enough for modest local hardware.
...
- [app/main.py](/Users/bhosseini/Documents/interview_agent/app/main.py): API routes and request handling
- [app/services/interview_engine.py](/Users/bhosseini/Documents/interview_agent/app/services/interview_engine.py): interview state machine and evaluation loop
- [app/services/llm.py](/Users/bhosseini/Documents/interview_agent/app/services/llm.py): Ollama and mock backends
- [app/db.py](/Users/bhosseini/Documents/interview_agent/app/db.py): SQLite persistence layer
- [app/prompts.py](/Users/bhosseini/Documents/interview_agent/app/prompts.py): prompt version loading and activation
- [app/services/review_analytics.py](/Users/bhosseini/Documents/interview_agent/app/services/review_analytics.py): aggregated feedback reporting and prompt suggestions
- [prompts/versions](/Users/bhosseini/Documents/interview_agent/prompts/versions): editable prompt definitions
...
Reference values are provided in [.env.example](/Users/bhosseini/Documents/interview_agent/.env.example).
...
[scripts/demo_flow.py](/Users/bhosseini/Documents/interview_agent/scripts/demo_flow.py) runs an end-to-end in-process demonstration with the mock backend and prints:
...
Run the local bonus demo:

```bash
make bonus-demo
```

[scripts/bonus_demo.py](/Users/bhosseini/Documents/interview_agent/scripts/bonus_demo.py) demonstrates:

- creating a new prompt version through the API
- running two completed interviews on different prompt versions
- retrieving a side-by-side comparison
- submitting preference feedback
- viewing aggregated evaluator feedback
- generating prompt improvement suggestions

## Prompt Update Path

Prompt behavior is controlled by files in [prompts/versions](/Users/bhosseini/Documents/interview_agent/prompts/versions). The currently active prompt is selected in [prompts/active_prompt.json](/Users/bhosseini/Documents/interview_agent/prompts/active_prompt.json).

To update prompts:

1. Add or edit a version file in [prompts/versions](/Users/bhosseini/Documents/interview_agent/prompts/versions).
...
- Core state transitions: [tests/test_interview_engine.py](/Users/bhosseini/Documents/interview_agent/tests/test_interview_engine.py)
- Feedback persistence and retrieval: [tests/test_feedback_api.py](/Users/bhosseini/Documents/interview_agent/tests/test_feedback_api.py)
- Prompt activation and loading: [tests/test_prompt_loading.py](/Users/bhosseini/Documents/interview_agent/tests/test_prompt_loading.py)
- Full API flow, retrieval, discovery, and metrics: [tests/test_api_flow.py](/Users/bhosseini/Documents/interview_agent/tests/test_api_flow.py)
- Bonus features: [tests/test_bonus_features.py](/Users/bhosseini/Documents/interview_agent/tests/test_bonus_features.py)
...
The only GitHub-related addition is the workflow file at [ci.yml](/Users/bhosseini/Documents/interview_agent/.github/workflows/ci.yml). For that file:
